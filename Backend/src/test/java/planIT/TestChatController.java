...
//        Response respnse = RestAssured.given().
//                when().
//                delete("/teams/1/user/A");
//        statusCode = response3.getStatusCode();
//        assertEquals(200, statusCode);
//
//        //DELETE team1
...
//    @Test
//    public void testCreateADDMessageInChat(){
...
//    @Test
//    public void testAddUserToChatAndRemove(){
...
//        assertEquals("{\"message\":\"success\"}", returnString);
//
//        //REMOVE USER B FROM CHAT
//        Response response4 =RestAssured.given().
//                when().
//                delete("/chats/1/users/B");
//        statusCode = response4.getStatusCode();
//        assertEquals(200, statusCode);
//
//        // DELTE TESTING USER
