 ...
 * @author Tristan Nono
 */
public class TeamMembersPage extends AppCompatActivity {
    private ImageButton back_button;
    private RecyclerView recycler_view;
    private LinearLayoutManager layout_manager;
    private List<UserFollower> user_list;
    private SearchView search_bar;
    private static final String URL_STRING_REQ = "http://coms-309-024.class.las.iastate.edu:8080/teams/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_members_page);
     ...
     */
    private void getUsersRequest(String id) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < usersArray.length(); i++) {
                                ...
                                user_list.add(new UserFollower(userId, userName));
                            }
